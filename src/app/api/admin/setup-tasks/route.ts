...
export async function POST(req: Request) {
  try {
    ...
    const summary = {
      userPhone,
      morningPromptTime: prefRows[0]?.daily_prompt_time || 'Not set',
      timezone: prefRows[0]?.timezone || 'Not set',
      notificationStyle: prefRows[0]?.notification_style || 'Not set',
    ...
    return NextResponse.json({
      success: true,
      message: 'Task management system setup complete! You will receive your first morning accountability text at 8:00 AM EST.',
      summary
    });
